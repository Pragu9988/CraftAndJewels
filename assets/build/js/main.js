...
const FilterBar = {
  ...
  toggleDropdown(item) {
    ...
    if (!isOpen) {
      item.classList.add('is-open');
      item.querySelector('.ht-filter-item__trigger')?.setAttribute('aria-expanded', 'true');
    }
  },
  closeAll() {
    this.items.forEach(item => {
      item.classList.remove('is-open');
      item.querySelector('.ht-filter-item__trigger')?.setAttribute('aria-expanded', 'false');
    });
  },
  getSelectedFilters() {
    const filters = {};
...
var navigation = __webpack_require__(638);
// EXTERNAL MODULE: ./src/js/shop-filters.js
var shop_filters = __webpack_require__(120);
// EXTERNAL MODULE: ./src/js/single-acordian.js
var single_acordian = __webpack_require__(415);
// EXTERNAL MODULE: ./src/js/tab.js
var tab = __webpack_require__(735);
// EXTERNAL MODULE: ./src/js/slider-animation.js
var slider_animation = __webpack_require__(599);
// EXTERNAL MODULE: ./src/js/faq.js
var faq = __webpack_require__(967);
