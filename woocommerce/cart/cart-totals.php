...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="flex justify-between items-center text-[var(--fs-350)] mb-3 relative z-10" style="padding-bottom: 8px;">
		<span style="color: var(--clr-neutral-500);">Total items</span>
		<span class="font-mono font-bold" style="color: var(--clr-neutral-550);"><?php echo sprintf('%02d', WC()->cart->get_cart_contents_count()); ?> Items</span>
	</div>
